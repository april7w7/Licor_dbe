...
Este script oferece opções para atualizar pacotes no Debian usando o licor(updater).

1. Atualizar todos os pacotes:
   - Esta opção atualiza todos os pacotes do sistema, incluindo os instalados pelo apt e Flatpak.
   - Nota: Certifique-se de ter o Flatpak instalado para atualizar todos os pacotes possíveis.
